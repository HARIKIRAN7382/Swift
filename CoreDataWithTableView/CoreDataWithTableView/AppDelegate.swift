...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    @objc lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = Bundle.main.url(forResource: "CoreDataWithTableView", withExtension: "momd")!
    ...
    @objc lazy var persistentStoreCoordinator: NSPersistentStoreCoordinator = {
        ...
        do {
            ...
            dict[NSLocalizedDescriptionKey] = "Failed to initialize the a as AnyObjectpplication's saved data" as AnyObject
